...
OUT = ROOT / "artifacts/town3d-general-store/model-review"
OUT.mkdir(parents=True, exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(Path(__file__).resolve().parent / "general-store.blend"))
...
for name, location in {
    ...
    bpy.context.scene.render.filepath = str(OUT / f"general-store-{name}.png")
