...
OUT = ROOT / "artifacts/town3d-claim-office/model-review"
OUT.mkdir(parents=True, exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(Path(__file__).resolve().parent / "claim-office.blend"))
...
for name, location in {
    ...
    bpy.context.scene.render.filepath = str(OUT / f"claim-office-{name}.png")
