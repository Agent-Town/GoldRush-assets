...
ARTIFACT_DIR = ROOT / "artifacts/town3d-claim-office"
CHECKED = SOURCE_DIR / "claim-office.glb"
REEXPORTED = ARTIFACT_DIR / "claim-office-reexport.glb"
...
def main():
    ...
    bpy.ops.wm.open_mainfile(filepath=str(SOURCE_DIR / "claim-office.blend"))
    ...
    (ARTIFACT_DIR / "reexport-evidence.md").write_text(
        "# Claim Office re-export evidence\n\n"
    ...
    assert checked["bounds"]["size"][0] <= 4.4 and checked["bounds"]["size"][2] <= 3.2
