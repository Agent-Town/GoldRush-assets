...
OUT = ROOT / "artifacts/town3d-chapel/model-review"
OUT.mkdir(parents=True, exist_ok=True)
bpy.ops.wm.open_mainfile(filepath=str(Path(__file__).resolve().parent / "chapel.blend"))
...
for name, location in {
    ...
    bpy.context.scene.render.filepath = str(OUT / f"chapel-{name}.png")
