...
OUT = ROOT / "artifacts/ark-long-table-hall-e10/current-references" / f"{BASE_SHA[:12]}-main"
...
e4 = load_module("hall_reference_e4", ROOT / "assets/pilots/tavern-3d/render_wave9_e4_wide.py")
e5 = load_module("hall_reference_e5", ROOT / "assets/pilots/tavern-3d/render_wave10_e5_harbor.py")
town = e4.town
...
def add_e6() -> None:
    ...
    warehouse = town.import_model(E6_MODELS["catalog_warehouse"], "Current:E6:catalog_warehouse",
                                  town.Point(-7.4, -16.6), math.pi)
...
def assemble() -> None:
    ...
    annotate(board, "FRESH CURRENT-MAIN REFERENCES | E1 / E4 / E5 / E6 / E7 / E8")
    ...
    contract = {
        "baseSha": BASE_SHA,
        "rule": "fresh render from current main GLBs; no previous evidence PNG is an input",
        "currentMainStopsAt": "E8 Dome Commons plate; E8/E9 populations and Ark waves are separate pushed branches awaiting merge",
        "order": ["E1 square", "E4 motor boulevard", "E5 submerged square", "E6 Atomic Mesa",
                  "E7 Signal Mesa", "E8 Dome Commons"],
