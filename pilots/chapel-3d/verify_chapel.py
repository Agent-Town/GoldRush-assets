...
ARTIFACT_DIR = ROOT / "artifacts/town3d-chapel"
CHECKED = SOURCE_DIR / "chapel.glb"
REEXPORTED = ARTIFACT_DIR / "chapel-reexport.glb"
...
def main():
    ...
    bpy.ops.wm.open_mainfile(filepath=str(SOURCE_DIR / "chapel.blend"))
    bpy.ops.object.select_all(action="DESELECT")
    chapel = bpy.data.objects["ChapelFullWrap"]
    ...
    assert checked["bounds"]["size"][0] <= 4.2 and checked["bounds"]["size"][2] <= 3.2
